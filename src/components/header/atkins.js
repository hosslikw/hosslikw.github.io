...
i.set(e, n);
const a = n.has(s);
return o ? n.add(s) : n.delete(s)
, a && o
}

function St(o, t) {
let e = o.target;
if (e instanceof Text && (e = e.parentElement)
, e instanceof Element && o.currentTarget instanceof Element) {
const s = e.closest(t);
if (s && o.currentTarget.contains(s))
return s
}
}
...
, this.hooks = ["animation:out:start", "animation:out:await", "animation:out:end", "animation:in:start", "animation:in:await",
"animation:in:end", "animation:skip", "cache:clear", "cache:set", "content:replace", "content:scroll", "enable", "disable", "fetch:request",
"fetch:error", "history:popstate", "link:click", "link:self", "link:anchor", "link:newtab", "page:load", "page:view", "scroll:top",
"scroll:anchor", "visit:start", "visit:end"]
, this.swup = t
, this.init()
}
init() {
...
return e || o !== "top" || (e = document.body)
, e
}
, P = "transition"
, H = "animation";
...
s.filter(Boolean)
.length > 0 ? await Promise.all(s) : t && console.warn(`[swup] No CSS animation duration defined on elements matching \`${t}\``)
}
...
const t = this.visit
, { el: e } = t.trigger;
o.referrer = o.referrer || this.currentPageUrl
, o.animate === !1 && (t.animation.animate = !1)
...
, typeof o.cache == "object" ? (t.cache.read = (n = o.cache.read) != null ? n : t.cache.read
, t.cache.write = (a = o.cache.write) != null ? a : t.cache.write) : o.cache !== void 0 && (t.cache = {
read: !!o.cache
, write: !!o.cache
})
, delete o.cache;
...
const r = this.hooks.call("page:load", {
options: o
}, async (l, h) => {
let d;
return l.cache.read && (d = this.cache.get(l.to.url))
, h.page = d || await this.fetchPage(l.to.url, h.options)
, h.cache = !!d
, h.page
});
if (!t.history.popstate) {
const l = t.to.url + t.to.hash;
t.history.action === "replace" || t.to.url === this.currentPageUrl ? q(l) : (this.currentHistoryIndex++
, kt(l, {
index: this.currentHistoryIndex
}))
}
if (this.currentPageUrl = y()
, t.animation.wait) {
...
if (t.id !== this.visit.id)
return;
await this.renderPage(u)
...
return;
console.error(r)
, this.options.skipPopStateHandling = () => (window.location.href = t.to.url + t.to.hash
, !0)
, window.history.go(-1)
}
}
...
const s = await this.hooks.call("fetch:request", {
url: o
, options: t
...
, a = await s.text();
if (i === 500)
throw this.hooks.call("fetch:error", {
status: i
, response: s
, url: n
})
...
return !this.visit.cache.write || t.method && t.method !== "GET" || o !== r || this.cache.set(c.url, c)
, c
}
const Ot = async function () {
this.visit.animation.animate ? (await this.hooks.call("animation:out:start", void 0, o => {
...
, await this.hooks.call("animation:out:await", {
skip: !1
}, async (o, { skip: t }) => {
t || await this.awaitAnimations({
...
, u = s.querySelector(r);
return c && u ? (c.replaceWith(u)
, !0) : (c || console.warn(`[swup] Container missing in current document: ${r}`)
...
let i = !1;
return s && (i = this.hooks.callSync("scroll:anchor", {
hash: s
, options: o
}, (n, { hash: a, options: r }) => {
const c = this.getAnchorElement(a);
return c && c.scrollIntoView(r)
, !!c
}))
, e && !i && (i = this.hooks.callSync("scroll:top", {
options: o
}, (n, { options: a }) => (window.scrollTo(g({
top: 0
, left: 0
}, a))
, !0)))
...
return;
const o = this.hooks.call("animation:in:await", {
skip: !1
}, async (t, { skip: e }) => {
e || await this.awaitAnimations({
...
, this.isSameResolvedUrl(y(), t) || (q(t)
...
, await this.hooks.call("content:replace", {
page: o
}, (s, { page: i }) => {
if (!this.replaceContent(i, {
containers: s.containers
}))
throw new Error("[swup] Container mismatch, aborting");
s.animation.animate && (this.classes.add("is-animating", "is-changing", "is-rendering")
, s.animation.name && this.classes.add(`to-${at(s.animation.name)}`))
})
...
, !!t?.isSwupPlugin) {
if (o.swup = this
, !o._checkRequirements || o._checkRequirements())
return o._beforeMount && o._beforeMount()
, o.mount()
, this.plugins.push(o)
, this.plugins
}
else
console.error("Not a swup plugin instance", o)
};
...
return t && typeof t == "string" ? t.startsWith("//") || t.startsWith("http") ? (console.warn("[swup] options.resolveUrl needs to return a relative url")
, o) : t : (console.warn("[swup] options.resolveUrl needs to return a url")
, o)
}
...
checkRequirements() {
return typeof Promise < "u" || (console.warn("Promise is not supported")
, !1)
}
async enable() {
var t;
...
, ((t = history.state) == null ? void 0 : t.source) !== "swup" && q(null, {
index: this.currentHistoryIndex
})
, await lt()
...
return i !== window.location.origin || !(!e || !this.triggerWillOpenNewWindow(e)) || !!this.options.ignoreVisit(n + a, {
el: e
, event: s
})
}
...
href: s
}) : t.button === 0 && this.hooks.callSync("link:click", {
el: e
, event: t
}, () => {
var a;
...
t.preventDefault()
, i && i !== r ? this.isSameResolvedUrl(i, r) || this.performNavigation() : n ? this.hooks.callSync("link:anchor", {
hash: n
}, () => {
q(i + n)
, this.scrollToContent()
}) : this.hooks.callSync("link:self", void 0, () => this.options.linkToSelf === "navigate" ? this.performNavigation() : (q(i)
, this.scrollToContent()))
}))
}
handlePopState(t) {
...
if (this.options.skipPopStateHandling(t) || this.isSameResolvedUrl(y(), this.currentPageUrl))
return;
...
u && u !== this.currentHistoryIndex && (this.visit.history.direction = u - this.currentHistoryIndex > 0 ? "forwards" : "backwards"
...
_afterUnmount() {}
_checkRequirements() {
return typeof this.requires != "object" || Object.entries(this.requires)
.forEach(([t, e]) => {
if (! function (s, i, n) {
const a = function (r, c) {
var u;
if (r === "swup")
return (u = c.version) != null ? u : "";
{
var l;
...
, this.scrollTo = e => {
if (e && e.nodeType)
this._targetPositionY = Math.round(e.getBoundingClientRect()
...
this._targetPositionY > document.documentElement.scrollHeight - window.innerHeight && (this._targetPositionY = document.documentElement
...
._positionY ? (this._raf = requestAnimationFrame(this._animate)
...
, this.getAnchorElement = (e = "") => typeof this.options.getAnchorElement == "function" ? this.options.getAnchorElement(e) : this.swup
.getAnchorElement(e)
, this.getOffset = e => e ? typeof this.options.offset == "function" ? parseInt(String(this.options.offset(e)), 10) : parseInt(String(this
.options.offset), 10) : 0
...
.scrollTo) == null || s.call(i, 0, e.scroll.animate)
, !0
}
...
var s, i;
if (e.history.popstate && !e.animation.animate)
return;
const n = (s = e.scroll.target) != null ? s : e.to.hash;
if (n && this.maybeScrollToAnchor(n, e.scroll.animate) || !e.scroll.reset)
return;
...
, t.scrollTo = (e, s = !0) => {
s ? this.scrl.scrollTo(e) : (t.hooks.callSync("scroll:start", void 0)
, window.scrollTo(0, e)
, t.hooks.callSync("scroll:end", void 0))
}
...
, this.options.markScrollTarget && (window.addEventListener("popstate", this.updateScrollTarget)
...
if (!n)
return console.warn(`Anchor target ${t} not found`)
, !1;
if (!(n instanceof Element))
return console.warn(`Anchor target ${t} is not a DOM node`)
, !1;
const { top: a } = n.getBoundingClientRect()
, r = a + window.scrollY - this.getOffset(n);
return (s = (i = this.swup)
.scrollTo) == null || s.call(i, r, e)
, !0
}
...
e && e.containers.length !== 0 && x(this.options.scrollContainers)
.forEach((s, i) => {
const n = e.containers[i];
n != null && (s.scrollTop = n.top
, s.scrollLeft = n.left)
})
}
updateScrollTarget() {
...
, s !== i && (s?.removeAttribute("data-swup-scroll-target")
, (t = i) == null || t.setAttribute("data-swup-scroll-target", ""))
}
}
const Xt = {
containers: ["#page"]
...
if (o) {
const t = document.querySelector(".single-project-image");
...
, ut = o => {
o.keyCode === 71 && o.ctrlKey === !0 && document.querySelector(".grid-overlay")
...
, document.querySelector(".mobile-menu-box-animate")
.style.setProperty("--targetHeight", k.clientHeight + "px")
, k.classList.contains("show") ? (document.querySelector(".mobile-menu-box-animate")
.classList.remove("animate-out")
, document.querySelector(".mobile-menu-box-animate")
.classList.add("animate-in")) : (document.querySelector(".mobile-menu-box-animate")
.classList.remove("animate-in")
, document.querySelector(".mobile-menu-box-animate")
.classList.add("animate-out")
, setTimeout(() => {
...
, 600))
, document.querySelector(".header-logo")
.classList.remove("menu-open")) : o === 1 && (j.classList.remove("hide")
, G = o)
};
let E = 1;
const yt = () => {
...
$ && $ == "on" ? (document.body.classList.add("text-mode")
, document.addEventListener("DOMContentLoaded", () => {
...
R && R == "on" ? (document.body.classList.add("mono-mode")
, document.addEventListener("DOMContentLoaded", () => {

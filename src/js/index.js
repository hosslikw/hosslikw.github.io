...
function St(o, t) {
  let e = o.target
  if (
    (e instanceof Text && (e = e.parentElement),
...
const at = (o, t) =>
    ...
    "",
  y = ({ hash: o } = {}) =>
    location.pathname + location.search + (o ? location.hash : ""),
  kt = (o, t = {}) => {
    const e = g(
      {
        url: (o =
...
class At {
  ...
  off(t, e) {
    const s = this.get(t)
    s && e
      ? s.delete(e) || console.warn(`Handler for hook '${t}' not found.`)
      : s && s.clear()
  }
  async call(t, e, s) {
    ...
    return await this.run(a, e), this.dispatchDomEvent(t, e), r
  }
  callSync(t, e, s) {
    const { before: i, handler: n, after: a } = this.getHandlers(t, s)
    this.runSync(i, e)
    const [r] = this.runSync(n, e)
    return this.runSync(a, e), this.dispatchDomEvent(t, e), r
  }
  async run(t, e) {
    const s = []
    for (const { hook: i, handler: n, defaultHandler: a, once: r } of t) {
      const c = await Tt(n, [this.swup.visit, e, a])
      s.push(c), r && this.off(i, n)
    }
    return s
  }
  runSync(t, e) {
  ...
  sortRegistrations(t, e) {
    var s, i
    return (
      ((s = t.priority) != null ? s : 0) - ((i = e.priority) != null ? i : 0) ||
      t.id - e.id ||
      0
    )
  }
...
async function Mt({ elements: o, selector: t }) {
  ...
  let e = []
  if (o) e = Array.from(o)
  else if (t && ((e = x(t, document.body)), !e.length))
          ...
          const p = () => {
            ...
            m = (v) => {
              if (v.target === n) {
                ...
                ;(performance.now() - h) / 1e3 < v.elapsedTime ||
                  (++d >= c && p())
              }
            }
          setTimeout(() => {
...
async function _t(o = {}) {
  ...
  i && (t.animation.name = i),
    typeof o.cache == "object"
      ? ((t.cache.read = (n = o.cache.read) != null ? n : t.cache.read),
        (t.cache.write = (a = o.cache.write) != null ? a : t.cache.write))
      : o.cache !== void 0 &&
        (t.cache = {
          read: !!o.cache,
          write: !!o.cache,
  ...
  try {
    ...
    const r = this.hooks.call(
      ...
      async (l, h) => {
        let d
        return (
          l.cache.read && (d = this.cache.get(l.to.url)),
...
function Bt(o) {
  return this.plugins.find(
    (t) => t === o || t.name === o || t.name === `Swup${String(o)}`,
  )
}
function Wt(o) {
...
class Vt {
  constructor(t = {}) {
    ...
    ;(this.version = "4.3.4"),
      ...
      (this.currentHistoryIndex =
        (e = (s = history.state) == null ? void 0 : s.index) != null ? e : 1),
  ...
  handlePopState(t) {
    var e, s, i, n
    const a =
      (e = (s = t.state) == null ? void 0 : s.url) != null ? e : location.href
    if (
      this.options.skipPopStateHandling(t) ||
      this.isSameResolvedUrl(y(), this.currentPageUrl)
    )
      return
...
class zt extends Ft {
    ...
    super(),
      ...
      (this.getAnchorElement = (e = "") =>
        typeof this.options.getAnchorElement == "function"
          ? this.options.getAnchorElement(e)
          : this.swup.getAnchorElement(e)),
      (this.getOffset = (e) =>
        e
          ? typeof this.options.offset == "function"
            ? parseInt(String(this.options.offset(e)), 10)
      ...
      (this.handleScrollToAnchor = (e, { hash: s }) =>
        this.maybeScrollToAnchor(s, e.scroll.animate)),
      ...
      (this.doScrollingBetweenPages = (e) => {
        ...
        if (
          (n && this.maybeScrollToAnchor(n, e.scroll.animate)) ||
          !e.scroll.reset
        )
          return
        ...
        requestAnimationFrame(() => {
          var c, u
          return (c = (u = this.swup).scrollTo) == null
            ? void 0
            : c.call(u, r, e.scroll.animate)
        }),
      ...
      (this.maybeResetScrollPositions = (e) => {
        const { popstate: s } = e.history,
          ...
          { el: n } = e.trigger
        s ||
          (n && !this.options.shouldResetScrollPosition(n)) ||
  ...
  mount() {
    ...
    t.hooks.create("scroll:start"),
      ...
      (t.scrollTo = (e, s = !0) => {
        s
          ? this.scrl.scrollTo(e)
          : (t.hooks.callSync("scroll:start", void 0),
            window.scrollTo(0, e),
  ...
  maybeScrollToAnchor(t, e = !1) {
    ...
    return (s = (i = this.swup).scrollTo) == null || s.call(i, r, e), !0
  }
  ...
  restoreScrollContainers(t) {
    ...
    e &&
      ...
      x(this.options.scrollContainers).forEach((s, i) => {
...
C.hooks.on("visit:start", () => {
  L.classList.remove("active"),
    ...
    k.classList.contains("show") &&
      ...
      document
        .querySelector(".mobile-menu-box-animate")
...
const ht = () => {
  ...
  mt = (o) => {
    o.keyCode === 68 && J(), o.keyCode === 84 && Q(), o.keyCode === 77 && Z()
  },
  ...
  pt = (o) => {
    ...
    s.appendChild(i.querySelector("img")), (i.style.opacity = "0")
...
const X = () => {
    if (window.innerWidth > 768) {
      let o =
          (document.body.scrollTop + document.documentElement.scrollTop) / M,
        t = 36 + (gt - 36) * (1 - o)
      o > 0 && o <= 1
        ? I.forEach((e) => {
            e.style.height = t + "px"
  ...
  Gt = (o, t) => {
    o === 2 && t > M
      ? (j.classList.add("hide"),
        ...
        document.querySelector(".header-logo").classList.remove("menu-open"))
      : o === 1 && (j.classList.remove("hide"), (G = o))
  }
let E = 1
const yt = () => {
    wt(), (E = 1)
  ...
  Jt = () => {
    ...
    let r = new IntersectionObserver(
      (l) => {
        l.forEach((d) => {
          d.isIntersecting
            ? (d.target.classList.add("has-been-seen"),
